...
function requireScheduler_production_min() {
  ...
  (function(exports$1) {
    ...
    var r2 = [], t = [], u = 1, v2 = null, y = 3, z = false, A = false, B = false, D = "function" === typeof setTimeout ? setTimeout : null, E = "function" === typeof clearTimeout ? clearTimeout : null, F = "undefined" !== typeof setImmediate ? setImmediate : null;
...
const v = Date.now();
const slides = [
  { id: 1, bg: `./figmaAssets/slide-1.jpg?v=${v}` },
  { id: 2, bg: `./figmaAssets/slide-2.jpg?v=${v}` },
  { id: 3, bg: `./figmaAssets/slide-3.png?v=${v}` },
  { id: 4, bg: `./figmaAssets/slide-4.png?v=${v}` },
  { id: 5, bg: `./figmaAssets/slide-5.png?v=${v}` }
];
const socialIcons = [
  { label: "Instagram", src: "./figmaAssets/insta.png", href: "#" },
  { label: "LinkedIn", src: "./figmaAssets/linkedin.png", href: "#" },
  { label: "TikTok", src: "./figmaAssets/tiktok-1.png", href: "#" },
  { label: "Telegram", src: "./figmaAssets/telegram.png", href: "#" },
  { label: "Behance", src: "./figmaAssets/behance.png", href: "#" }
];
...
function LandingPage() {
  ...
  const goTo = (index2) => {
    if (locked || index2 === current) return;
    setLocked(true);
    setCurrent(index2);
  ...
  reactExports.useEffect(() => {
    const timer = setInterval(() => setCurrent((c) => (c + 1) % slides.length), 5e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex w-full max-w-[1440px] items-center justify-between gap-6 px-5 py-1 md:px-8 lg:px-[72px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => scrollTo("home"), className: "shrink-0 cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "h-[58px] w-auto object-contain", alt: "Logo", src: "./figmaAssets/icon-logo-1.png" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-wrap items-center justify-end gap-4", children: [
        { label: "HOME", id: "home" },
        ...
        "button",
        {
          ...
          className: "h-auto min-w-[94px] rounded-[10px] border border-white bg-transparent px-7 py-[6px] text-white hover:bg-white/10 [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[32px] leading-none tracking-[0] transition-colors cursor-pointer",
          children: item.label
        },
        item.id
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative h-screen overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 h-[76px] bg-black z-10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-[80px] z-10", style: { background: "linear-gradient(to top, black 60%, transparent)" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-full items-center justify-between px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            onClick: prev,
            className: "p-4 transition-transform duration-150 hover:scale-110 active:scale-90",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "28", height: "42", viewBox: "0 0 28 42", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M26 2L4 21L26 40", stroke: "white", strokeWidth: "4", strokeLinecap: "round", strokeLinejoin: "round" }) })
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: next,
            className: "p-4 transition-transform duration-150 hover:scale-110 active:scale-90",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "28", height: "42", viewBox: "0 0 28 42", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 2L24 21L2 40", stroke: "white", strokeWidth: "4", strokeLinecap: "round", strokeLinejoin: "round" }) })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "w-full bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: `./figmaAssets/portfolio-bg.png?v=${v}`,
          alt: "Portfolio",
          className: "w-full",
          style: { marginTop: "-72px" }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 inset-x-0", style: { height: "14%", background: "linear-gradient(to top, black 60%, transparent)" } })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "bg-black py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[560px] px-5 md:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "[font-family:'Tungsten_Narrow-Black',Helvetica] text-[88px] font-black leading-none text-white text-center mb-4", children: "CONTACT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "[font-family:'Tungsten_Narrow-Medium',Helvetica] text-[18px] leading-[1.5] text-white text-center mb-8", children: "Please don't hesitate to get in touch with me, whether you're interested in hiring me or simply want to say hello!" }),
      submitted ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "[font-family:'Tungsten_Narrow-Black',Helvetica] text-[48px] text-white text-center py-12", children: "THANKS! I'LL BE IN TOUCH SOON." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[20px] font-bold text-white mb-1", children: "NAME *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
              ...
              required: true,
              className: "w-full rounded-[4px] border border-white bg-transparent px-4 py-3 text-white placeholder-white/50 [font-family:'Tungsten_Narrow-Medium',Helvetica] text-[18px] focus:outline-none"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[20px] font-bold text-white mb-1", children: "EMAIL ADDRESS *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "email",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[20px] font-bold text-white mb-1", children: "MESSAGE *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              ...
              required: true,
              rows: 7,
              className: "w-full rounded-[4px] border border-white bg-transparent px-4 py-3 text-white placeholder-white/50 [font-family:'Tungsten_Narrow-Medium',Helvetica] text-[18px] focus:outline-none resize-none"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: "rounded-[4px] border border-white bg-transparent px-8 py-[6px] text-white hover:bg-white hover:text-black [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[28px] leading-none transition-colors",
            children: "SUBMIT"
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "bg-black py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[720px] px-5 md:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "[font-family:'Tungsten_Narrow-Black',Helvetica] text-[88px] font-black leading-none text-white text-center mb-8", children: "ABOUT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "[font-family:'Tungsten_Narrow-Medium',Helvetica] text-[20px] leading-[1.5] text-white space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Hi, I'm Dmytro, a freelance creative from the Ukraine." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Worked with over 10 football players" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Create Thumbnails for 3 YouTube Channels" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "5 years experience in Sports Design" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-I understand the importance of social media in today's world, and I'm dedicated to helping my clients stand out on Instagram and YouTube." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-I'm always interested in working with new clients and solving their problems through creative content development." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-When working with me, you can expect a collaborative process where I listen to your needs and provide unique solutions that meet your goals." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "My work process involves:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-learning your brand's unique voice and style," }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-researching the latest trends suit your goals," }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "-and creating custom designs that fit your needs." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I value my attention to detail, creativity, and ability to deliver quickly." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Let's work together to create stunning content that will capture your audience's attention and elevate your brand!" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-[1440px] px-5 md:px-8 lg:px-[72px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center gap-4 py-8 md:flex-row md:gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "[font-family:'Tungsten_Narrow-Semibold',Helvetica] text-center text-4xl font-normal leading-[1] text-white whitespace-nowrap", children: "WANT TO WORK TOGETHER? GET IN TOUCH!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => scrollTo("contact"),
            className: "h-auto min-w-[168px] rounded-[10px] border border-white bg-transparent px-8 py-[4px] text-white hover:bg-white/10 [font-family:'Tungsten_Narrow-Bold',Helvetica] text-[32px] leading-none transition-colors",
            children: "CONTACT"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between gap-6 pb-8 md:flex-row md:items-end border-t border-white/10 pt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "[font-family:'Tungsten_Narrow-Bold',Helvetica] text-[32px] font-bold leading-none text-white whitespace-nowrap", children: "© 2023 dmhpkl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-8", children: socialIcons.map((icon) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: icon.href, "aria-label": icon.label, className: "transition-opacity hover:opacity-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "h-6 w-auto object-contain", alt: icon.label, src: icon.src }) }, icon.label)) })
      ] })
    ] }) })
  ] });
}
